...
GAIA_YEARLY_ROOT = Path(os.environ.get("UHN_SYNC_GAIA_YEARLY_ROOT", EXTERNAL_ROOT / "gaia_yearly"))
WARM_SEASON_INPUT_ROOT = Path(
    os.environ.get("UHN_SYNC_WARM_SEASON_INPUT_ROOT", EXTERNAL_ROOT / "warm_season_local_warm3")
)
WARM_SEASON_WORK_ROOT = Path(
    os.environ.get("UHN_SYNC_WARM_SEASON_WORK_ROOT", EXTERNAL_ROOT / "warm_season_work")
)
